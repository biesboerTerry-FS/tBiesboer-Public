...
let distance = (numGallons*percentTank)/mpg;

if(distance >200){
   document.querySelector(:#distance) .innerHTML =("Yes, you can drive"+distance+" and you can make it without stopping for gas!;
}
