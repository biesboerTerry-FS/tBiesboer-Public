...
if(userInput = no)
{
    console.log("Your total purchase is $"+(price1 + price2);
}

if(userInput = yes)
{
    console.log("Your total purchase is $"+((price1+price2))*0.85)+", which includes your 15% discount");
}
