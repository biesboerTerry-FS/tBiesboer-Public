...
let userInput = prompt("Are you a preferred member? Please answer yes or no.");

// let maybe = prompt("You have typed in something wrong and I can not calculate the total. Please refresh page and start again.");
...
{
    console.log("Your total purchase is $"+(total*0.85)+", which includes your 15% discount");
}

if(userInput == "maybe")
{
    console.logprompt("You have typed in something wrong and I can not calculate the total. Please refresh page and start again.");
}
