...
document.querySelector("#button2").addEventListener("click", function(e){
    if(distance >=200){document.querySelector("#distance").innerHTML ="Yes, you can drive "+distance+" miles and you can make it without stopping for gas!"; document.querySelector("#photo").src ="img/enoughGas.jpg";
    else if(distance <200 && distance >0){
        document.querySelector("#distance").innerHTML="You can only drive "+distance+ " miles more, better get gas while you can"; document.querySelector("#photo").src="img/notEnough"
})
