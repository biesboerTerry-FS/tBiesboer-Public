...
{
    if(distance >=200){
        document.querySelector("#distance").innerHTML ="Yes, you can drive "+distance+" miles and you can make it without stopping for gas!";document.querySelector("#photo").hidden = true;
    }
    else if(distance <200 && distance >0){
        document.querySelector("#distance").innerHTML="You can only drive "+distance+ " miles more, better get gas while you can"; document.querySelector("#photo").hidden = true;
    }
});
...
{
    if(distance >=200)
    {document.querySelector("#photo").src ="img/enoughGas.jpg";document.querySelector("#text").hidden=true}

    else if(distance <200 && distance >0)
    {document.querySelector("#photo").src="img/notEnoughGas.jpg";document.querySelector("#text").hidden=true}}
);

//alert("Check console for final output");