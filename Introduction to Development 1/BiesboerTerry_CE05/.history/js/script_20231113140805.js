...
{
    if(distance >=200){
        document.querySelector("#distance").innerHTML ="Yes, you can drive "+distance+" miles and you can make it without stopping for gas!";document.querySelector("#photo").hidden;
    }
    else if(distance <200 && distance >0){
