...
if(distance >=200){
    document.querySelector("#button1").addEventListener("click", function(e),document.querySelector("#distance").innerHTML ="Yes, you can drive "+distance+" miles and you can make it without stopping for gas!"; document.querySelector("#photo").src ="img/enoughGas.jpg";
}
