...
{
    if(distance >=200){
        document.querySelector("#text").innerHTML ="Yes, you can drive "+distance+" miles and you can make it without stopping for gas!";document.querySelector("#photo").hidden = true;
    }
    else if(distance <200 && distance >0){
