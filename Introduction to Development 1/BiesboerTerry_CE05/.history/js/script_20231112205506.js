...
let price1 = parseFloat(prompt("What is the price of your first item in dollars?"))toFixed;
let price2 = parseFloat(prompt("What is the price of your second item?"));
let subtotal = price1 + price2;
let total1 = subtotal*.90;toFixed(2);
let total2 = subtotal*.95;toFixed(2);
...
let receipt = prompt("How would you like the information displayed? By Text or Text and Image");
