...
if(distance >=200){
   ...
   document.querySelector("#img").innerHTML = <img src="img/enoughGas.jpg"
}

if (distance <200 && distance >0){
    document.querySelector("#good").innerHTML = "You can only drive "+distance+ " miles more, better get gas while you can";
