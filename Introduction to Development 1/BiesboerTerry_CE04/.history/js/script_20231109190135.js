...
{
    console.log("You have a(n) "+grade+" % gives you a grade of A");
}
...
if(grade <=89 || grade >=80 )
{
 ...
 {
    console.log("Your score of "+grade+"gives you a grade of C");
 }

 if(grade <=69 || grade >=60)
 {
    console.log("Your score of "+grade+" gives you a grade of D");
 }

 if(grade <= 59 && grade >= 0)
 {
    console.log("Your score of "+grade+"gives you a grade of F");
 }