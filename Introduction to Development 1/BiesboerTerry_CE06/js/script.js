...
document.querySelector("#movie").addEventListener("click", function(e)
{
      ...
      {
             document.querySelector("#totalMovies").innerHTML = `Wow! Your collection contains ${totalDiscs} movies , which makes you a gold star member`, document.querySelector("#imageResult").src = "img/goldStar.jpg";
      }
}
});
