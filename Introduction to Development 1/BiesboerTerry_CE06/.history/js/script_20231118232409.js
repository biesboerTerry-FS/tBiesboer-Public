...
document.querySelector("#startCalc").addEventListener("click", function(e)
{
   ...
   {
      parseInt(document.querySelector("#quartsAmount").value = qtsAmount); document.querySelector("#inPints").value = null; document.querySelector("#inCups").value =null;
   }
  else if(document.querySelector("#inPints").checked)
  {
      parseInt(document.querySelector("#pintsAmount").value = ptsAmount); document.querySelector("inQuarts").value =null; document.querySelector("#inCups").value =null;
  }
  else if(document.querySelector("#inCups").checked)
{
      parseInt(document.querySelector("#cupsAmount").value = cpsAmount); document.querySelector("#inQuarts").value =null; document.querySelector("#inPints").value ="";
}
   }
});
//    {
