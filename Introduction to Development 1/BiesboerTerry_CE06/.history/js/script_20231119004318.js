...
{
   document.querySelector("#totalMovies").innerHTML = `Wow! Your collection conttain ${totalDiscs} , which makes you a gold star member`, document.querySelector("#imageResult").src="img/goldStar.jpg";
