...
document.querySelector("#movie").addEventListener("click", function(e)
{
      ...
      if(document.querySelector("#numDvd").reportValidity() && document.querySelector("#numBlu").reportValidity() && document.querySelector("#numUltra").reportValidity())
      {
            ...
            let totalDiscs = (qtyDvd + qtyBlu + qtyUltra);
      ...
      {
             document.querySelector("#totalMovies").innerHTML = `Wow! Your collection contains ${totalDiscs} moviea , which makes you a gold star member`, document.querySelector("#imageResult").src = "img/goldStar.jpg";
      }
}
});
