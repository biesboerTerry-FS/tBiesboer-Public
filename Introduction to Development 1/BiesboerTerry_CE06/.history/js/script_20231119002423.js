...
{
   document.querySelector("#totalMovies").innerHTML = `Your collection contains only ${totalDiscs} movies, which makes you a bronze star member.`, document.querySelector("#imageResult").src="img/bronzeStar.j";
}
else if(totalDiscs >=50 && totalDiscs <=99)
{
   document.querySelector("#totalMovies").innerHTML = `Your collection contains ${totalDiscs} movies, which makes you a silver star member.`;
}
else if(totalDiscs >=100)
{
   document.querySelector("totalMovies").innerHTML = `Wow! Your collection contatin ${totalDiscs} , which makes you a gold star member`;
