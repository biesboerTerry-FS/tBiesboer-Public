...
{
   if(document.querySelector("#numGals"))reportValidity() && document.querySelector("inQuarts").reportValidity() || document.querySelector("inPints").reportValidity() || document.querySelector
