...
{
   document.querySelector("#totalMovies").innerHTML = `Wow! Your collection contain ${totalDiscs} , which makes you a gold star member`, document.querySelector("#imageResult").src="img/goldStar.jpg";
