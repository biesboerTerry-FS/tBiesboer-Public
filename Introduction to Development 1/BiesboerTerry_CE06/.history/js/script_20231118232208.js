...
document.querySelector("#startCalc").addEventListener("click", function(e)
{
  ...
  {
      parseInt(document.querySelector("#pintsAmount").value = ptsAmount); document.querySelector("#in
      Quartts").value =""; document.querySelector("#inPints").value ="";
  }
  else if(document.querySelector("#inCups").checked)
{
      parseInt(document.querySelector("#cupsAmount").value = cpsAmount); document.querySelector("#inPints").value =""; document.querySelector("#inPints").value ="";
}
   }
});
//    {
