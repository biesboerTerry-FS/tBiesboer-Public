...
{
     let quartsAmount = document.querySelector("#numGals").value = numGals/4; alert("Quarts is selecrted")
    let pintsAmount = document.querySelector("#numGals").value = numGals/8;  console.log("Pints is selected");
    let cupsAmount = document.querySelector("#numGals").value = numGals/16; console.log("Cups is selected");
   if (id="#inQuarts")
