...
document.querySelector("#startCalc").addEventListener("click", function(e)
{
   ...
   if (id="#inQuarts")
    {document.querySelector("#inQuarts").reportValidity() .input="quartsAmount"; checked}

    else if(id="#inPints"){document.querySelector("#inPints").reportValidity().input="pintsAmount";checked}

   else if(id="#inCups"){document.querySelector("inCups").reportValidity() .input="cupsAmount";checked}
});