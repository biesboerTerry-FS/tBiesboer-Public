...
{
     let quartsAmount = document.querySelector("#numGals").value = numGals/4;
    let pintsAmount = document.querySelector("#numGals").value =numGals/8;    
    let cupsAmount = document.querySelector("#numGals").valuenumGals/16;
//     if (id="#inQuarts")
