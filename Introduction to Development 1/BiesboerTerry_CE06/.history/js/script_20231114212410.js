...
{
    if(document.querySelector("#inQuarts").reportValidity()) value="qua";

    else if(document.querySelector("#inPints").reportValidity()); 

    else if(document.querySelector("inCups").reportValidity());
}
);