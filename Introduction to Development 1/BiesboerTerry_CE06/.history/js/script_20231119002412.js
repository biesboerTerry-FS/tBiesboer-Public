...
{
   document.querySelector("#totalMovies").innerHTML = `Your collection contains only ${totalDiscs} movies, which makes you a bronze star member.`, document.querySelector("#imageResult").src=;
}
