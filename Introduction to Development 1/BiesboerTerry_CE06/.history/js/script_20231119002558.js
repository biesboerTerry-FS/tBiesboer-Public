...
{
   document.querySelector("totalMovies").innerHTML = `Wow! Your collection contatin ${totalDiscs} , which makes you a gold star member`, document.querySelector("#imageResult").src="img/" ;
