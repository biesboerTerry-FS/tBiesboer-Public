...
{
    if(document.querySelector("#inQuarts").reportValidity());
}
else if(document.querySelector("#inPints").ATTRIBUTE_NODE.reportValidity());  
else (document.querySelector("inCups").reportValidity)
);