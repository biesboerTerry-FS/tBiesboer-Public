...
{
   document.querySelector("#totalMovies").innerHTML = `our collection contains only ${totalDiscs} movies, which makes you a bronze star member.`;
}
else if(totalDiscs >=50 && totalDiscs <=99)
{
   document.querySelector("#totalMovies").innerHTML = `our collection contains ${totalDiscs} movies, which makes you a silver star member.`;
}
else if(totalDiscs >=100)document.querySelector("totalMovies").innerHTML =  document.querySelector("#totalMovies").innerHTML = `our collection contains only ${totalDiscs} movies, which makes you a bronze star member.`;
{
