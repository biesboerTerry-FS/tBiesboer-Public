...
{
   document.querySelector("#totalMovies").innerHTML = `Your collection contains ${totalDiscs} movies, which makes you a silver star member.`, document.querySelector("#imageResult");
}
