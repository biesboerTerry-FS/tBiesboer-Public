...
document.querySelector("#startCalc").addEventListener("click", function(e)
{
   ...
   {
      parseInt(document.querySelector("#quartsAmount").value = qtsAmount); document.querySelector("#inPints").value =""; document.querySelector("#inPints").value ="";
   }
  else if(document.querySelector("#inPints").checked)
  {
      parseInt(document.querySelector("#pintsAmount").value = ptsAmount); document.querySelector("#inPints").value =""; document.querySelector("#inPints").value ="";
  }
