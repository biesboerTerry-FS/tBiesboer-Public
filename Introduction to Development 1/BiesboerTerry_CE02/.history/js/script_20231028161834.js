...
console.log("Let me tell you the story of "+userName+"'s mansion.");
//
...
//
var favMovie = prompt("Awesome, "+userName+" tell me, that is your favorite movie?");

console.log("Ironically, "+userName"'s mansion was the backdrop for that film.");
//
