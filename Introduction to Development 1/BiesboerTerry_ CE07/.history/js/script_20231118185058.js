...
document.querySelector("#calcBMI").addEventListener("click", function(e){
    ...
    {
        document.querySelector("#finalResult").innerHTML = `Your BMI is ${bmi.toFixed(1)} , indicating your weight is Under Weight Range)}`; document.querySelector("#image").innerHTML
;    }
});