...
document.querySelector("#calcBMI").addEventListener("click", function(e)
{
    ...
    )
    {
        ...
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bodyMassIndexi.tofixed(1)} , indicating your weight is within the Extreme Obese range for adults of your age.`; document.querySelector("#image").src="img/obeseWeight.jpg"
        }
