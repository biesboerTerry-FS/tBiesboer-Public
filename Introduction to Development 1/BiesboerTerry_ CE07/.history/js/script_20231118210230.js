...
document.querySelector("#calcBMI").addEventListener("click", function(e)
{
    ...
    )
    {
        ...
        if(bodyMassIndex >= 0 && bodyMassIndex <=18.49){
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bodyMassIndex.toFixed(1)} , indicating your weight is Under Weight range for adults `; document.querySelector("#image").src ="img/underWeight.jpg";
        }
        }
        else if(bodyMassIndex >=18.50 && bodyMassIndex <=24.8)
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bodyMassIndex.tofixed(1)} , indicating your weight is within Hea`; document.querySelector("#image").src="img/healthyWeight.jpg"
        }
