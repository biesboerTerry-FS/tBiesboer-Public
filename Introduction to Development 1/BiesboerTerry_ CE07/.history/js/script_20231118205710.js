...
document.querySelector("#calcBMI").addEventListener("click", function(e)
{
    ...
    )
    {
        ...
        if(bodyMassIndex >= 0 && bodyMassIndex <=18.49){
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${body.toFixed(1)} , indicating your weight is Under Weight Range`; document.querySelector("#image").src ="img/underWeight.jpg";
        }
        }
        else if(bodyMassIndex >=18.50 && bodyMassIndex)
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bmi.tofixed(1)} , indicating your weight is`; document.querySelector("#image").src="img/healthyWeight.jpg"
        }
        else if(bodyMassIndex >=18.50 && bodyMassIndex)
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bmi.tofixed(1)} , indicating your weight is`; document.querySelector("#image").src="img/"
        }
        else if(bodyMassIndex >=18.50 && bodyMassIndex)
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bmi.tofixed(1)} , indicating your weight is`; document.querySelector("#image").src="img/"
