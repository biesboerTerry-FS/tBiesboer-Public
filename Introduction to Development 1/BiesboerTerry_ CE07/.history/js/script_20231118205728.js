...
document.querySelector("#calcBMI").addEventListener("click", function(e)
{
    ...
    )
    {
        ...
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bodyMassIndexi.tofixed(1)} , indicating your weight is`; document.querySelector("#image").src="img/healthyWeight.jpg"
        }
        else if(bodyMassIndex >=18.50 && bodyMassIndex)
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bodyMassIndex.tofixed(1)} , indicating your weight is`; document.querySelector("#image").src="img/"
        }
        else if(bodyMassIndex >=18.50 && bodyMassIndex)
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${odyi.tofixed(1)} , indicating your weight is`; document.querySelector("#image").src="img/"
        }
