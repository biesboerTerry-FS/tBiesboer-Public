...
document.querySelector("#calcBMI").addEventListener("click", function(e)
{
    ...
    )
    {
        ...
        {
            document.querySelector("#finalResult").innerHTML = `Your BMI is ${bodyMassIndex.tofixed(1)} , indicating your weight is within`; document.querySelector("#image").src="img/healthyWeight.jpg"
        }
