...
let price1 = parseprompt ("What is the price of the item?");

//Prompt for first item quantity
let qty1 = parseprompt ("How many are you purchasing?");

//Prompt for second item
let item2 = prompt ("What is the name of your second item?");

//Prompt for second item cost
let price2 = parseprompt("What is the price of the item?");

//Prompt for second item quantity
let qty2 = parseprompt("How many are you purchasing?");
