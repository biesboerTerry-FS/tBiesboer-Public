...
let price1 = Numberprompt ("What is the price of the item?");
console.log ("Each "+item1+" is $"+price1);

//Prompt for first item quantity
let qty1 = prompt ("How many are you purchasing?");
console.log("You're buying "+qty1);

//Prompt for second item
let item2 = prompt ("What is the name of your second item?");

//Prompt for second item cost
let price2 = prompt("What is the price of the item?");

//Prompt for second item quantity
let qty2 = prompt("How many are you purchasing?");
